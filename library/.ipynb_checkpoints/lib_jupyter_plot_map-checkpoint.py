...
def plot_map_var(file_path, var_darray, var_time, var_limit_min=None, var_limit_max=None,
                 ...
                 tag_sep=' ', fig_color_map_type=None, fig_dpi=150):
...
def plot_map_terrain(file_path, darray_data, dict_section,
    ...
    map_data = darray_data.values
    map_lons_1d = np.float32(darray_data[tag_terrain_geo_x].values)
    map_lats_1d = np.float32(darray_data[tag_terrain_geo_y].values)
